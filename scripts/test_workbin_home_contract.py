...
class HomeContractTests(unittest.TestCase):
    ...
    def check(self, hashes):
        ...
        mapping = {'body_first_home_sha':'BODY_FIRST_HOME_SHA', 'head_sha':'HEAD_LOWER_SHA', 'ready_sha':'ARMS_READY_SHA',
...
'''
    ...
    def test_reviewed_overlay_and_vendor_original_recognized(self):
        for pin, label in [('BODY_FIRST_HOME_SHA', 'body-first-v4-20s'), ('OPEN_HOME_SHA', 'open-v3-20s'), ('DIRECT_HOME_SHA', 'vendor-direct-6s')]:
