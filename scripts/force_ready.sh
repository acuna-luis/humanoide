...
docker exec -i "$CONTAINER" bash -lc '
    ...
    readonly TASK_PREFIX="s2_bio_vla/ready410_h63_access"

    for task_number in 01 02 03 04 05; do
        task_name="${TASK_PREFIX}_${task_number}_forward"
        ...
        printf "Acción finalizada: %s\n" "$task_name"
    done
'

echo "Las cinco acciones han finalizado correctamente."
REMOTE