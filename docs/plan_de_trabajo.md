...
**Actualización vigente 11-09 — VLA retomado en E6.1, revisión ENTRY offline.**
[Comparación y próximos pasos](vla/REVISION_ENTRY_ERGUIDA_20260911.md).
150 entradas task0 revisadas: ENTRY40 da31,196° por FK;113 entradas completas
dan≤5° y cumplen límites articulares. Candidatos438 (4,362°, menor cambio)
y430 (0,022°, casi vertical). No se cambia el contrato ni fixture: muñecas
unos14–16cm más altas. Ocho pruebas pasan. Siguiente entrega: RGB/fixture y
acceso/recuperación del candidato; después contrato y cinco shadow (aún0/5).
VLA físico0/4. Sin conexión ni movimiento. Los estados del08-09 siguientes
son históricos; no representan la postura actual. Los ensayos HOME/PICO del
11-09 no validan una nueva ENTRY ni el retorno general.
